...
Exoplayer provides options to play many different formats, so the code can easily be tweaked to
play the requested format.
...
//
////LIVE STREAM SOURCE: * Livestream links may be out of date so find any m3u8 files online and
// replace:
//
////        Uri mp4VideoUri =Uri.parse("http://81.7.13.162/hls/ss1/index.m3u8"); //random 720p
// source
////        Uri mp4VideoUri =Uri.parse
// ("http://54.255.155.24:1935//Live/_definst_/amlst:sweetbcha1novD235L240P/playlist.m3u8");
// Radnom 540p indian channel
//        Uri mp4VideoUri =Uri.parse("http://cbsnewshd-lh.akamaihd
// .net/i/CBSNHD_7@199302/index_700_av-p.m3u8"); //CNBC
        Uri mp4VideoUri = Uri.parse("http://live.field59.com/wwsb/ngrp:wwsb1_all/playlist.m3u8");
        //ABC NEWS
////        Uri mp4VideoUri =Uri.parse("FIND A WORKING LINK ABD PLUg INTO HERE"); //PLUG INTO
// HERE<------------------------------------------
//
//
...
////        Uri mp4VideoUri = Uri.parse(Environment.getExternalStorageDirectory().getAbsolutePath
// ()+urimp4);
...
//        simpleExoPlayerView = new SimpleExoPlayerView(this);
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(this, Util
                .getUserAgent(this, "exoplayer2example"), bandwidthMeter);
        // This is the MediaSource representing the media to be played.
//        MediaSource videoSource = new ExtractorMediaSource.Factory(dataSourceFactory)
// .createMediaSource(liveStreamUri);

        //// II. ADJUST HERE:

        ////        DefaultDataSourceFactory dataSourceFactory = new DefaultDataSourceFactory
        // (this, Util.getUserAgent(this, "exoplayer2example"), bandwidthMeterA);
        ...
        //FOR LIVESTREAM LINK:
//        MediaSource videoSource = new HlsMediaSource(mp4VideoUri, dataSourceFactory, 1, null,
// null);
        ...
        player.addAnalyticsListener(new DefaultAnalyticsListener() {
            @Override
            public void onVideoSizeChanged(EventTime eventTime, int width, int height, int
                    unappliedRotationDegrees, float pixelWidthHeightRatio) {
                super.onVideoSizeChanged(eventTime, width, height, unappliedRotationDegrees,
